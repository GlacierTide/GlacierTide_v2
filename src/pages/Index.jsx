...
const FeatureCard = ({ 
  ...
  >
    ...
    <h3 className="text-xl font-semibold text-ice-900 mb-2">{title}</h3>
    <p className="text-ice-600">{description}</p>
  </div>
);
        ...
        <section className="py-20 bg-white">
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold text-ice-900 mb-4">
                Explore Our Features
              </h2>
              <p className="text-ice-600 max-w-2xl mx-auto">
        ...
        <section className="py-20 bg-glacier-50">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              <h2 className="text-3xl md:text-4xl font-bold text-ice-900 mb-6">
                Join the GlacierTide Community
              </h2>
              <p className="text-ice-700 text-lg mb-8">
