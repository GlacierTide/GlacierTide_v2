                                                    ...
                                                    <div className="flex items-center justify-between mb-1">
                                                        <div className="flex space-x-1 w-full">
                                                            <div className={`h-2 flex-1 rounded-l-full ${
                                                                passwordStrength.strength >= 1 ? 'bg-red-500' : 'bg-ice-200'
                                                            }`}></div>
                                                            <div className={`h-2 flex-1 ${
                                                                passwordStrength.strength >= 2 ? 'bg-yellow-500' : 'bg-ice-200'
                                                            }`}></div>
                                                            <div className={`h-2 flex-1 rounded-r-full ${
                                                                passwordStrength.strength >= 3 ? 'bg-green-500' : 'bg-ice-200'
                                                            }`}></div>
                                                        </div>
